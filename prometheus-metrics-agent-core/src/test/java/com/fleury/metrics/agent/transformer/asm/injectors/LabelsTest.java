...
public class LabelsTest extends BaseMetricTest {
    ...
    public void shouldCountConstructorInvocationWithLabels() throws Exception {
        testInvocation(CountedConstructorWithLabelsClass.class, new String[] {"name1", "name2"}, new String[]{"value1", "value2"});
    }

    @Test
    public void shouldCountConstructorInvocationWithoutLabels() throws Exception {
        testInvocation(CountedConstructorWithoutLabelsClass.class, new String[] {}, new String[] {});
    }

    @Test
    public void shouldCountConstructorInvocationWithEmptyLabels() throws Exception {
        testInvocation(CountedConstructorWithEmptyLabelsClass.class, new String[] {}, new String[] {});
    }
    ...
    public void shouldThrowExceptionWithInvalueDynamicLabelValueThisInConstructor() throws Exception {
        testInvocation(CountedConstructorWithDynamicLabelValueThisClass.class, new String[] {"name1"}, new String[]{"hello"});
    }
    ...
    private void testInvocation(Class instrumentClazz, String[] labelNames, String[] labelValues) throws Exception {
        Class<?> clazz = execute(instrumentClazz);

        clazz.newInstance();

        assertEquals(1, metrics.getCount("constructor", labelNames, labelValues));
    }
    ...
    private void testInvocationWithArgs(Class instrumentClazz, Object[] args, String[] labelValues) throws Exception {
        ...
        assertEquals(1, metrics.getCount("constructor", new String[] {"name1"}, labelValues));
    }
    ...
    private void testMethodInvocation(Class instrumentClazz, String[] labelValues) throws Exception {
        ...
        assertEquals(1, metrics.getCount("method", new String[] {"name1"}, labelValues));
    }
